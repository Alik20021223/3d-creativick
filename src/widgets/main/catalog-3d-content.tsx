...
const Catalog3dContent = () => {
  ...
  return (
    <section ref={topRef} className='relative bg-white'>
      ...
      <div className='container-custom relative z-10 w-full md:px-10 md:py-20'>
        {/* заголовок и подзаголовок */}
        <div className='flex flex-col items-center space-y-4 text-center'>
          <h1 className='title-text text-white'>Каталог 3D-моделей</h1>

          <p className='text-md max-w-[902px] text-white md:text-lg'>
            В частности, разбавленное изрядной долей эмпатии, рациональное мышление предоставляет
            широкие возможности для экспериментов, поражающих их по своей масштабности и
            грандиозности
          </p>
        </div>
          ...
          {CATEGORIES.map((name) => {
            ...
            return (
              <button
                ...
                className={[
                  'cursor-pointer rounded-[12px] text-sm leading-[130%] select-none md:px-5.5 md:py-[8.5px] md:text-lg',
