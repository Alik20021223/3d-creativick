  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        'bg-secondary-white inline-flex w-full items-center justify-between rounded-md md:rounded-full',
        className,
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'inline-flex flex-1 items-center justify-center gap-2 rounded-md px-5 py-2 text-sm font-medium whitespace-nowrap md:rounded-full',
...
function TabsContent({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.Content>) {
  return (
    <TabsPrimitive.Content
      ...
      className={cn('flex-1 outline-none', 'data-[state=active]:animate-fade-in-up', className)}
      {...props}
    />
  );
}
